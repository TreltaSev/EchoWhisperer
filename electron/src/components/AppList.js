...
const AppDetailChip = (props) => {
    ...
    return (
        <div style={{borderRadius: 10, borderColor: 1, minHeight: 40, position: "relative"}} className={`${styling.flex_row} ${styling.align_items_center} ${styling.align_self_stretch} ${custom_styling.AppList_full_border_white}`}>
            { /* Left Side Chip */}
...
const AppList = () => {
    return (
        <div style={{width: 320, padding: "30px 10px", gap:10}} className={`${styling.flex_col} ${styling.align_items_center} ${styling.border_box} ${styling.flex_fill_height} ${styling.dark_sub} ${styling.border_right} ${styling.dark_accent}`}>
